...
public class PtvDisruptionTest {

    @Test
    public void testDisruptionsObject() throws Exception {
        final PtvDisruptionInformation result = new Gson().fromJson(new FileReader(TestUtils.getResourcePath("testDisruption.json")), PtvDisruptionInformation.class);
