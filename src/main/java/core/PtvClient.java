...
public class PtvClient {
    ...
    public <T> T executeRequest(final Request request) {
        return executeRequest(request, ResponseDeserializerFactory.instance().obtainDeserializer(request.getClass()));
    }

    public String executeRequestWithRawResponse(final Request request) {
